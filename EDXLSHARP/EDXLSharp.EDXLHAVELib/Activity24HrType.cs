...
{
  /// <summary>
  /// The container for all component parts of the Activity24HrType sub-element of the HAVE message 
  /// </summary>
  [Serializable]
  public partial class Activity24HrType : IComposable
  {
    ...
    #region Constructors
    /// <summary>
    /// Initializes a new instance of the Activity24HrType class Default Constructor - Initializes Lists (if applicable)
    /// </summary>
