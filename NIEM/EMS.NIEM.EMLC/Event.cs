  ...
  public class Event : IGeoRSS
    {
        ...
        public Event()
        {
            ...
            this.EventValidityDateTimeRange = new DateTimeRange();
      this.EventComment = new List<EventComment>(0);
      this.Details = new List<EventDetails>(0);
      ...
      // TODO: Validate NIEM Message?
            ...
            foreach (XmlNode node in deroot.ChildNodes)
            {
                ...
                switch (node.LocalName)
                {
                    ...
                    case "EventTypeDescriptor":
                        ...
                        EventTypeDescriptor.EventTypeCode = doc.GetElementsByTagName("EventTypeCode", Constants.EmeventNamespace)[0].InnerText;
        ...
        public static string GetXmlAttrNameFromEnumValue<T>(T pEnumVal)
        {
            ...
            //TODO: Check this change for .NET Core conversion
            XmlEnumAttribute att = info.GetCustomAttributes<XmlEnumAttribute>(false).FirstOrDefault();

            if (att != null)
                return att.Name;
            return "";

            // 02/22/2017 original below
        ...
        /// </summary>
        [XmlElement(ElementName = "EventIdentification", Namespace = Constants.MoNamespace, Order = 2)]
        [JsonProperty("EventIdentification")]
        ...
        /// </summary>
        [XmlElement(Namespace = Constants.EmeventNamespace, Order = 0)]
        [JsonProperty]
        ...
        /// </summary>
        [XmlElement(Namespace = Constants.MoNamespace, Order = 1)]
        [JsonProperty]
        ...
        /// </summary>
        [XmlElement(Namespace = Constants.MoNamespace, Order = 3)]
        [JsonProperty]
        public DateTimeRange EventValidityDateTimeRange
        {
            get; set;
        }
        ...
        /// </summary>
        [XmlElement(ElementName = "EventMessageDateTime", Namespace = Constants.MoNamespace, Order = 4)]
        ...
        public EventLink[] SerialEventLink
        {
            ...
            set
            {
                ...
                {
                    this.EventLink = new List<EventLink>(value);
                }
            }
        }
        ...
        public EventComment[] SerialEventComment
        {
            ...
            set
            {
                ...
                {
                    this.EventComment = new List<EventComment>(value);
                }
            }
        }

    /// <summary>
    /// Holds the list of detail extension for this event
    /// </summary>
    [XmlIgnore]
    public List<EventDetails> Details
    {
      get; set;
    }
    ...
    /// </summary>
    [XmlElement("IncidentDetail", typeof(IncidentDetail), Namespace = Constants.EmlcNamespace, Order = 8)]
    [XmlElement("ResourceDetail", typeof(ResourceDetail), Namespace = Constants.EmlcNamespace, Order = 8)]
    [XmlElement("InfrastructureDetail", typeof(InfrastructureDetail), Namespace = Constants.EmlcNamespace, Order = 8)]
    [XmlElement("MutualAidDetail", typeof(MutualAidDetail), Namespace = Constants.MaidNamespace, Order = 8)]
    [XmlElement("SensorDetail", typeof(SensorDetail), Namespace = Constants.SensorNamespace, Order = 8)]
    [JsonProperty]
    public EventDetails[] SerialDetails
    {
      get { return this.Details.ToArray(); }

      set
      {
        this.Details = new List<EventDetails>(value);
        ...
        /// <see cref="EMLC.EventTypeDescriptor.EventTypeDescriptorExtension"/> 
        /// </summary>
        ...
        /// <summary>
        /// Adds point for Cylinder location 
        /// <see cref="Point"/> 
        /// </summary>
        ...
        /// <see cref="NIEMCommon.DateTimeRange"/>
        /// </summary>
