  ...
  public partial class ValueList : IComposable
  {
    ...
    public ValueList(string valuelisturnin, List<string> valuesin)
    {
      ...
      foreach (string s in valuesin)
      {
        ...
        public ValueList(XmlNode nodeIn)
        {
            this.ReadXML(nodeIn);
        }
    #endregion
    ...
    public string[] ValueXML
    {
      ...
      set
      {
        ...
        /// <summary>
        /// Returns a concatenated string of all the strings in Value collection
        /// </summary>
        //public string ValueSummary
        //{
        //    /* if this is called often, we may want to set and store concatenated string contents whenever 
        //     * the value list is modified, instead of performing this loop every time the property is accessed, to make
        //     * it more efficient.*/
        //    get
        //    {
