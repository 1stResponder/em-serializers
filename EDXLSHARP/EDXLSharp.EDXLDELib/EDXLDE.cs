...
namespace EDXLSharp.EDXLDELib
{
  ...
  public class EDXLDE
  {
    ...
    /// <seealso cref="ExplicitAddressXML"/>   
    ...
    /// <seealso cref="ContentObjectsXML"/>
    ...
    public EDXLDE()
    {
      ...
      this.Xmlns.Add("de", EDXLConstants.EDXLDE10Namespace);
    }

    /// <summary>
    /// Initializes a new instance of the EDXLDE class
    /// Constructor that will parse XML from a string
    /// Fails if the XML string is not a valid EDXLDE object.
    /// </summary>
    ...
    /// For serialization/deserialization <see cref="SenderRoleXML"/>
    /// </remarks>
    /// <seealso cref="senderRole"/>
    /// <seealso cref="SenderRoleXML"/>
    [XmlIgnore]
    public IList<ValueList> SenderRole
    {
    ...
    /// The root name of this list is specified when the list is initialized.
    /// 
    /// For serialization/deserialization <see cref="RecipientRoleXML"/>
    /// </remarks>
    /// <seealso cref="recipientRole"/>
    /// <seealso cref="RecipientRoleXML"/>
    [XmlIgnore]
    public IList<ValueList> RecipientRole
    {
    ...
    /// <remarks>
    /// The root name of this list is specified when the list is initialized.
    /// For serialization/deserialization <see cref="KeywordXML"/>
    /// </remarks>
    /// <seealso cref="keyword"/>
    /// <seealso cref="KeywordXML"/>
    [XmlIgnore]
    public IList<ValueList> Keyword
    {
    ...
    /// 
    /// For serialization/deserialization <see cref="DistributionReferenceXML"/></remarks>
    /// <seealso cref="DistributionRefHandler"/>
    ...
    /// </value>
    /// <remarks>
    /// For serialization/deserialization <see cref="ExplicitAddressXML"/>
    /// </remarks>
    /// <seealso cref="explicitAddress"/>
    /// <seealso cref="ExplicitAddressXML"/>   
    [XmlIgnore]
    ...
    /// 
    /// For serialization/deserialization <see cref="TargetAreaXML"/></remarks>
    /// <seealso cref="targetArea"/>
    /// <seealso cref="TargetAreaXML"/>
    [XmlIgnore]
    ...
    /// </list>
    /// 
    /// For serialization/deserialization <see cref="ContentObjectsXML"/>
    /// </remarks>
    /// <seealso cref="contentObjects"/>
    /// <seealso cref="ContentObjectsXML"/>
    /// <seealso cref="ContentObject"/>
    ...
    /// <seealso cref="VLList.WriteXML(XmlWriter)"/>
    ...
    // TODO: How is this suppose to be used?  Right now it's checking a list that will always be empty, so will always return null
    /// <summary>
