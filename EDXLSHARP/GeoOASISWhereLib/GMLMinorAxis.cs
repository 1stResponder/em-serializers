// ———————————————————————–
// <copyright file="GMLMinorAxis.cs" company="EDXLSharp">
...
{
  /// <summary>
  /// Minor axis representation
  /// </summary>
  public class GMLMinorAxis : GMLLengthType
  {
    /// <summary>
    ...
    /// <summary>
    /// Gets the schema prefix for the element
    /// </summary>
