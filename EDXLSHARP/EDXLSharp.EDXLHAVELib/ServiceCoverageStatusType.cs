...
namespace EDXLSharp.EDXLHAVELib
{
  ...
  public partial class ServiceCoverageStatusType : IComposable
  {
    ...
    public void WriteXML(XmlWriter xwriter)
    {
      ...
      {
        xwriter.WriteElementString("Orthopedic", this.orthopedic.ToString().ToLower());
      }
      ...
      if (this.traumaCenterServices != null)
      {
        ...
        if (this.traumaCenterServicesLevel != null)
        {
    ...
    public void ReadXML(XmlNode rootnode)
    {
      foreach (XmlNode node in rootnode.ChildNodes)
      {
        ...
        {
          case "Burn":
            this.burn = bool.Parse(node.InnerText);
            break;
          case "CardiologyIndicator":
            foreach (XmlNode childNode in node.ChildNodes)
            {
              ...
              {
                case "Cardiology":
                  this.cardiology = bool.Parse(childNode.InnerText);
                  break;
                  ...
                  foreach (XmlNode subChildNode in childNode.ChildNodes)
                  {
                    ...
                    switch (subChildNode.LocalName)
                    {
                      case "CardiologyInvasive":
                        this.cardiologyInvasive = bool.Parse(subChildNode.InnerText);
                        break;
                      case "CardiologyNonInvasive":
                        this.cardiologyNonInvasive = bool.Parse(subChildNode.InnerText);
                        break;
                    }
                  }
            ...
            break;
          case "Dialysis":
            this.dialysis = bool.Parse(node.InnerText);
            break;
          case "EmergencyDepartment":
            this.emergencyDepartment = bool.Parse(node.InnerText);
            break;
          case "HyperbaricChamber":
            this.hyperbaricChamber = bool.Parse(node.InnerText);
            break;
          case "InfectiousDisease":
            this.infectiousDisease = bool.Parse(node.InnerText);
            break;
          case "Neonatology":
            this.neonatology = bool.Parse(node.InnerText);
            break;
          case "NeurologyIndicator":
            foreach (XmlNode childNode in node.ChildNodes)
            {
              ...
              {
                case "Neurology":
                  this.neurology = bool.Parse(childNode.InnerText);
                  break;
                  ...
                  foreach (XmlNode subChildNode in childNode.ChildNodes)
                  {
                    ...
                    switch (subChildNode.LocalName)
                    {
                      case "NeurologyInvasive":
                        this.neurologyInvasive = bool.Parse(subChildNode.InnerText);
                        break;
                      case "NeurologyNonInvasive":
                        this.neurologyNonInvasive = bool.Parse(subChildNode.InnerText);
                        break;
                    }
                  }
          ...
          case "OBGYNIndicator":
            foreach (XmlNode childNode in node.ChildNodes)
            {
              ...
              {
                case "OBGYN":
                  this.obgyn = bool.Parse(childNode.InnerText);
                  break;
                case "OBGYNSubType":
                  foreach (XmlNode subChildNode in childNode.ChildNodes)
                  {
                    ...
                    switch (subChildNode.LocalName)
                    {
                      case "OBGYNWithLaborDelivery":
                        this.obgynWithLaborDelivery = bool.Parse(subChildNode.InnerText);
                        break;
                      case "OBGYNWithoutLaborDelivery":
                        this.obgynWithoutLaborDelivery = bool.Parse(subChildNode.InnerText);
                        break;
                    }
                  }
            ...
            break;
          case "Ophthalmology":
            this.ophthalmology = bool.Parse(node.InnerText);
            break;
          case "Orthopedic":
            this.orthopedic = bool.Parse(node.InnerText);
            break;
          case "Pediatrics":
          ...
          case "PsychiatricIndicator":
            foreach (XmlNode childNode in node.ChildNodes)
            {
              ...
              {
                case "Psychiatric":
                  this.psychiatric = bool.Parse(childNode.InnerText);
                  break;
                  ...
                  foreach (XmlNode subChildNode in childNode.ChildNodes)
                  {
                    ...
                    switch (subChildNode.LocalName)
                    {
                      case "PsychiatricAdultGeneral":
                        this.psychiatricAdultGeneral = bool.Parse(subChildNode.InnerText);
                        break;
                      case "PsychiatricPediatric":
                        this.psychiatricPediatric = bool.Parse(subChildNode.InnerText);
                        break;
                    }
                  }
          ...
          case "SurgeryIndicator":
            foreach (XmlNode childNode in node.ChildNodes)
            {
              ...
              {
                case "Surgery":
                  this.surgery = bool.Parse(childNode.InnerText);
                  break;
                case "SurgerySubType":
            ...
            foreach (XmlNode childNode in node.ChildNodes)
            {
              ...
              switch (childNode.LocalName)
              {
                case "TransportServices":
                  this.transportServices = bool.Parse(childNode.InnerText);
                  break;
                  ...
                  foreach (XmlNode subChildNode in childNode.ChildNodes)
                  {
                    ...
                    switch (subChildNode.LocalName)
                    {
                      case "AmbulanceServices":
                        this.ambulanceServices = bool.Parse(subChildNode.InnerText);
                        break;
                      case "AirTransportServices":
                        this.airTransportServices = bool.Parse(subChildNode.InnerText);
                        break;
                    }
                  }
            ...
            foreach (XmlNode childNode in node.ChildNodes)
            {
              ...
              switch (childNode.LocalName)
              {
                case "TraumaCenterServices":
                  this.traumaCenterServices = bool.Parse(childNode.InnerText);
                  break;
