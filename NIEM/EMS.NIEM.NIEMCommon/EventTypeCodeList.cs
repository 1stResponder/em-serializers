...
namespace EMS.NIEM.NIEMCommon
{
  ...
  public enum EventTypeCodeList
  {
    ...
    /// Sensor
    /// </summary>
    ATOM_GRDTRK_EQT_SENSOR,

    /// <summary>
    /// Environmental Sensor
    /// </summary>
    ATOM_GRDTRK_EQT_SENSOR_ENVIRONMENTAL,

    /// <summary>
    ///Environmental  Sensor - Air
    /// </summary>
    ATOM_GRDTRK_EQT_SENSOR_ENVIRONMENTAL_AIR,

    /// <summary>
    ///Environmental  Sensor - Air Humidity
    /// </summary>
    ATOM_GRDTRK_EQT_SENSOR_ENVIRONMENTAL_AIR_HUMIDITY,

    /// <summary>
    /// Environmental Sensor - Air Pressure
    /// </summary>
    ATOM_GRDTRK_EQT_SENSOR_ENVIRONMENTAL_AIR_PRESSURE,

    /// <summary>
    /// Environmental Sensor - Air Temperature
    /// </summary>
    ATOM_GRDTRK_EQT_SENSOR_ENVIRONMENTAL_AIR_TEMPERATURE,

    /// <summary>
    /// Location Sensor
    /// </summary>
    ATOM_GRDTRK_EQT_SENSOR_LOCATION,

    /// <summary>
    /// Location Sensor - 2D
    /// </summary>
    ATOM_GRDTRK_EQT_SENSOR_LOCATION_XY,

    /// <summary>
    /// Location Sensor - 3D
    /// </summary>
    ATOM_GRDTRK_EQT_SENSOR_LOCATION_XYZ,

    /// <summary>
    /// Physiological Sensor
    /// </summary>
    ATOM_GRDTRK_EQT_SENSOR_PHYSIOLOGICAL,

    /// <summary>
    /// Physiological Sensor - Heart Rate
    /// </summary>
    ATOM_GRDTRK_EQT_SENSOR_PHYSIOLOGICAL_HEARTRATE,

    /// <summary>
    /// Physiological Sensor - Physical Strain Index
    /// </summary>
    ATOM_GRDTRK_EQT_SENSOR_PHYSIOLOGICAL_PSI,

    /// <summary>
    /// Physiological Sensor - Respiration Rate
    /// </summary>
    ATOM_GRDTRK_EQT_SENSOR_PHYSIOLOGICAL_RESPIRATIONRATE,

    /// <summary>
    /// Physiological Sensor - Skin Temperature
    /// </summary>
    ATOM_GRDTRK_EQT_SENSOR_PHYSIOLOGICAL_SKINTEMPERATURE,

    /// <summary>
    /// Physiological Sensor - Blood Oxygen Saturation
    /// </summary>
    ATOM_GRDTRK_EQT_SENSOR_PHYSIOLOGICAL_SPO2,

    /// <summary>
    /// Power Sensor
    /// </summary>
    ATOM_GRDTRK_EQT_SENSOR_POWER,

    /// <summary>
    /// Power Sensor - Battery
    /// </summary>
    ATOM_GRDTRK_EQT_SENSOR_POWER_BATTERY,
