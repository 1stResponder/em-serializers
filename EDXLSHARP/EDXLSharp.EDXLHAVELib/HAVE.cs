...
namespace EDXLSharp.EDXLHAVELib
{
  ...
  public partial class EDXLHAVE : IContentObject, IGeoRSS
  {
    ...
    /// <summary>
    /// Gets the date and time when this message is invalid
    /// </summary>
    ...
    public void ValidateToSchema()
    {
      ...
      StringReader xsdsr = new StringReader(EDXLSharp.EDXLHAVELib.Properties.Resources.edxl_have);
      ...
      StringReader commontypesread = new StringReader(EDXLSharp.EDXLHAVELib.Properties.Resources.CommonTypes);
      XmlReader commonxsd = XmlReader.Create(commontypesread);
      coll.Add(EDXLConstants.CIQCommonTypesNamespace, commonxsd);
      StringReader geooasisread = new StringReader(EDXLSharp.EDXLHAVELib.Properties.Resources.geo_oasis);
      XmlReader geooasisxsd = XmlReader.Create(geooasisread);
      coll.Add(EDXLConstants.GeoOASISWhereNamespace, geooasisxsd);
      StringReader gmlread = new StringReader(EDXLSharp.EDXLHAVELib.Properties.Resources.gml_oasis);
      XmlReader gmlxsd = XmlReader.Create(gmlread);
      coll.Add(EDXLConstants.GMLNamespace, gmlxsd);
      StringReader xalread = new StringReader(EDXLSharp.EDXLHAVELib.Properties.Resources.xAL);
      XmlReader xalxsd = XmlReader.Create(xalread);
      coll.Add(EDXLConstants.XAL10Namespace, xalxsd);
      StringReader xaltypesread = new StringReader(EDXLSharp.EDXLHAVELib.Properties.Resources.xAL_types);
      XmlReader xaltypesxsd = XmlReader.Create(xaltypesread);
      coll.Add(EDXLConstants.XAL10Namespace, xaltypesxsd);
      StringReader xlink2read = new StringReader(EDXLSharp.EDXLHAVELib.Properties.Resources.xlink_2003_12_31);
      XmlReader xlink2xsd = XmlReader.Create(xlink2read);
      coll.Add("http://www.w3.org/1999/xlink1", xlink2xsd);
      StringReader xlinksread = new StringReader(EDXLSharp.EDXLHAVELib.Properties.Resources.xlinks);
      XmlReader xlinksxsd = XmlReader.Create(xlinksread);
      coll.Add("http://www.w3.org/1999/xlink", xlinksxsd);
      StringReader xnlread = new StringReader(EDXLSharp.EDXLHAVELib.Properties.Resources.xNL);
      XmlReader xnlxsd = XmlReader.Create(xnlread);
      coll.Add(EDXLConstants.XNL10Namespace, xnlxsd);
      StringReader xnltypesread = new StringReader(EDXLSharp.EDXLHAVELib.Properties.Resources.xNL_types);
      XmlReader xnltypesxsd = XmlReader.Create(xnltypesread);
      coll.Add(EDXLConstants.XNL10Namespace, xnltypesxsd);
      StringReader xpilread = new StringReader(EDXLSharp.EDXLHAVELib.Properties.Resources.xPIL);
      XmlReader xpilxsd = XmlReader.Create(xpilread);
      coll.Add(EDXLConstants.XPIL10Namespace, xpilxsd);
      StringReader xpiltypesread = new StringReader(EDXLSharp.EDXLHAVELib.Properties.Resources.xPIL_types);
